...
const requiredFiles = [
  ...
  "0a-docs/agent-workflows/multi-agent-coding-operation-manual-v2.md",
  "0a-docs/agent-workflows/grok-native-vs-codex-grok-cli.md",
  ...
  "0a-docs/prompts/supervisor-start-grok.md",
