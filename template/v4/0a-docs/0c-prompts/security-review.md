...
- 如果项目使用无人值守 auto 模式执行，检查 Spec 安全边界与运行脚本权限是否匹配。
...
把需要修复的问题转成可执行的修复阶段草案，按优先级排序。每个阶段包含：
...
<粘贴 0a-docs/0a-spec/ 下已确认的 Spec>

## Roadmap

<粘贴 0b-goals/ROADMAP.md，说明已完成阶段和待人工验收清单>
